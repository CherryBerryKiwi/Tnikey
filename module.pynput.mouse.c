...
static void createModuleCodeObjects(void) {
    ...
    codeobj_dfaf1aabdc5a52fc098c44fdcb334537 = MAKE_CODE_OBJECT(module_filename_obj, 1, 0, mod_consts[60], mod_consts[60], NULL, NULL, 0, 0, 0);
    codeobj_e4a719dc92921765e035f39f10b9eca3 = MAKE_CODE_OBJECT(module_filename_obj, 62, 0, mod_consts[9], mod_consts[9], mod_consts[61], NULL, 0, 0, 0);
    codeobj_f91168f025d20cb40adb1df731ed6be9 = MAKE_CODE_OBJECT(module_filename_obj, 36, 0, mod_consts[6], mod_consts[6], mod_consts[61], NULL, 0, 0, 0);
    codeobj_aee92f72a73b646e0f7d376e9fcac5db = MAKE_CODE_OBJECT(module_filename_obj, 52, 0, mod_consts[8], mod_consts[8], mod_consts[61], NULL, 0, 0, 0);
    codeobj_cac85508fcc47318b13abf80d1558eb1 = MAKE_CODE_OBJECT(module_filename_obj, 78, 0, mod_consts[10], mod_consts[10], mod_consts[61], NULL, 0, 0, 0);
    codeobj_b67c0429ea64ea4aef3edbd12cb0182d = MAKE_CODE_OBJECT(module_filename_obj, 94, CO_OPTIMIZED | CO_NEWLOCALS, mod_consts[7], mod_consts[7], mod_consts[62], NULL, 1, 0, 0);
    codeobj_6d630ed3aad96ac93cab727859fe102d = MAKE_CODE_OBJECT(module_filename_obj, 55, CO_OPTIMIZED | CO_NEWLOCALS, mod_consts[7], mod_consts[7], mod_consts[63], NULL, 3, 0, 0);
    codeobj_220f1a63275a91775cc73f678b121d2a = MAKE_CODE_OBJECT(module_filename_obj, 65, CO_OPTIMIZED | CO_NEWLOCALS, mod_consts[7], mod_consts[7], mod_consts[64], NULL, 5, 0, 0);
    codeobj_644040bc67bed914c41e996a356d1d14 = MAKE_CODE_OBJECT(module_filename_obj, 81, CO_OPTIMIZED | CO_NEWLOCALS, mod_consts[7], mod_consts[7], mod_consts[65], NULL, 5, 0, 0);
}
