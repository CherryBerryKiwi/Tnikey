...
static PyCodeObject *codeobj_c9416bc02237232db0aaf3f8207795a4;

static void createModuleCodeObjects(void) {
    module_filename_obj = MAKE_RELATIVE_PATH(mod_consts[8]); CHECK_OBJECT(module_filename_obj);
    codeobj_c9416bc02237232db0aaf3f8207795a4 = MAKE_CODE_OBJECT(module_filename_obj, 1, 0, mod_consts[9], mod_consts[9], NULL, NULL, 0, 0, 0);
}
...
// Mark the execution in the "__spec__" value.
    ...
    struct Nuitka_FrameObject *frame_c9416bc02237232db0aaf3f8207795a4;
    ...
    frame_c9416bc02237232db0aaf3f8207795a4 = MAKE_MODULE_FRAME(codeobj_c9416bc02237232db0aaf3f8207795a4, module_PIL$_version);

    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStackCompiledFrame(tstate, frame_c9416bc02237232db0aaf3f8207795a4);
    assert(Py_REFCNT(frame_c9416bc02237232db0aaf3f8207795a4) == 2);
    ...
    if (exception_tb == NULL) {
        exception_tb = MAKE_TRACEBACK(frame_c9416bc02237232db0aaf3f8207795a4, exception_lineno);
    } else if (exception_tb->tb_frame != &frame_c9416bc02237232db0aaf3f8207795a4->m_frame) {
        exception_tb = ADD_TRACEBACK(exception_tb, frame_c9416bc02237232db0aaf3f8207795a4, exception_lineno);
    }



    assertFrameObject(frame_c9416bc02237232db0aaf3f8207795a4);
