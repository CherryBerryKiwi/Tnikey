...
static function_impl_code const function_table_pystray$_util$win32[] = {
    impl_pystray$_util$win32$$$function__1__err,
    NULL
};
...
static PyObject *_reduce_compiled_function(PyObject *self, PyObject *args, PyObject *kwds) {
    ...
    int offset = Nuitka_Function_GetFunctionCodeIndex(function, function_table_pystray$_util$win32);
...
static PyObject *_create_compiled_function(PyObject *self, PyObject *args, PyObject *kwds) {
    ...
    return (PyObject *)Nuitka_Function_CreateFunctionViaCodeIndex(
        ...
        doc,
        closure,
        function_table_pystray$_util$win32,
        sizeof(function_table_pystray$_util$win32) / sizeof(function_impl_code)
    );
}
...
#if defined(_NUITKA_MODULE) && 0
    PyObject *pre_load = IMPORT_EMBEDDED_MODULE(tstate, "pystray._util.win32" "-preLoad");
    if (pre_load == NULL) {
        return NULL;
    }
#endif
...
// Mark the execution in the "__spec__" value.
    ...
    }
    {
...

        {
            ...
            tmp_assign_source_94 = impl___main__$$$function__4__mro_entries_conversion(tstate, dir_call_args);
        }
    ...
    branch_end_4:;
    {
        ...
        }
        {
...

            {
                ...
                tmp_assign_source_101 = impl___main__$$$function__4__mro_entries_conversion(tstate, dir_call_args);
            }
        ...
        }
        {
...

            {
                ...
                tmp_assign_source_108 = impl___main__$$$function__4__mro_entries_conversion(tstate, dir_call_args);
            }
    ...
    }
    {
...

        {
            ...
            tmp_assign_source_117 = impl___main__$$$function__4__mro_entries_conversion(tstate, dir_call_args);
        }
    ...
    }
    {
...

        {
            ...
            tmp_assign_source_126 = impl___main__$$$function__4__mro_entries_conversion(tstate, dir_call_args);
        }
...
#if defined(_NUITKA_MODULE) && 0
    PyObject *post_load = IMPORT_EMBEDDED_MODULE(tstate, "pystray._util.win32" "-postLoad");
    if (post_load == NULL) {
        return NULL;
    }
#endif
