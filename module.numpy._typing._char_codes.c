...
static void createModuleCodeObjects(void) {
    ...
    codeobj_afa93da2007247c2fdfdc1fe0f62b2a5 = MAKE_CODE_OBJECT(module_filename_obj, 1, 0, mod_consts[87], mod_consts[87], NULL, NULL, 0, 0, 0);
}
...
#if defined(_NUITKA_MODULE) && 0
    PyObject *pre_load = IMPORT_EMBEDDED_MODULE(tstate, "numpy._typing._char_codes" "-preLoad");
    if (pre_load == NULL) {
        return NULL;
    }
#endif
...
// Mark the execution in the "__spec__" value.
    ...
    // owning it.
    pushFrameStackCompiledFrame(tstate, frame_afa93da2007247c2fdfdc1fe0f62b2a5);
...
#if defined(_NUITKA_MODULE) && 0
    PyObject *post_load = IMPORT_EMBEDDED_MODULE(tstate, "numpy._typing._char_codes" "-postLoad");
    if (post_load == NULL) {
        return NULL;
    }
#endif
