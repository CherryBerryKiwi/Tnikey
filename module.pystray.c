...
static function_impl_code const function_table_pystray[] = {
    impl_pystray$$$function__1_backend$$$function__1_dummy,
    impl_pystray$$$function__1_backend$$$function__2_appindicator,
    impl_pystray$$$function__1_backend$$$function__3_darwin,
    impl_pystray$$$function__1_backend$$$function__4_gtk,
...
static PyObject *_reduce_compiled_function(PyObject *self, PyObject *args, PyObject *kwds) {
    ...
    int offset = Nuitka_Function_GetFunctionCodeIndex(function, function_table_pystray);
...
static PyObject *_create_compiled_function(PyObject *self, PyObject *args, PyObject *kwds) {
    ...
    return (PyObject *)Nuitka_Function_CreateFunctionViaCodeIndex(
        ...
        doc,
        closure,
        function_table_pystray,
        sizeof(function_table_pystray) / sizeof(function_impl_code)
    );
}
...
#if defined(_NUITKA_MODULE) && 0
    PyObject *pre_load = IMPORT_EMBEDDED_MODULE(tstate, "pystray" "-preLoad");
    if (pre_load == NULL) {
        return NULL;
    }
#endif
...
#if defined(_NUITKA_MODULE) && 0
    PyObject *post_load = IMPORT_EMBEDDED_MODULE(tstate, "pystray" "-postLoad");
    if (post_load == NULL) {
        return NULL;
    }
#endif
