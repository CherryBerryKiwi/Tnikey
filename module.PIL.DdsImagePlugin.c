...
#if defined(_NUITKA_MODULE) && 0
    PyObject *pre_load = IMPORT_EMBEDDED_MODULE(tstate, "PIL.DdsImagePlugin" "-preLoad");
    if (pre_load == NULL) {
        return NULL;
    }
#endif
...
// Mark the execution in the "__spec__" value.
    ...
    }
    {
...

        {
            ...
            tmp_assign_source_75 = impl___main__$$$function__4__mro_entries_conversion(tstate, dir_call_args);
        }
...
#if defined(_NUITKA_MODULE) && 0
    PyObject *post_load = IMPORT_EMBEDDED_MODULE(tstate, "PIL.DdsImagePlugin" "-postLoad");
    if (post_load == NULL) {
        return NULL;
    }
#endif
