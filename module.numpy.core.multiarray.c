...
#if defined(_NUITKA_MODULE) && 0
    PyObject *pre_load = IMPORT_EMBEDDED_MODULE(tstate, "numpy.core.multiarray" "-preLoad");
    if (pre_load == NULL) {
        return NULL;
    }
#endif
...
#if defined(_NUITKA_MODULE) && 0
    PyObject *post_load = IMPORT_EMBEDDED_MODULE(tstate, "numpy.core.multiarray" "-postLoad");
    if (post_load == NULL) {
        return NULL;
    }
#endif
